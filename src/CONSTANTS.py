...
weapon_dict = {
    ...
    "deathScythe": Weapon(
        ...
        "Mythic",
        "Slash",
        os.path.join(base_directory, "assets/img/swords/death_scythe.png"),
        os.path.join(base_directory, "assets/sound/swoosh.wav"),
        0.1,
        -20,
        15,
    ...
    "holyMantle": Weapon(
        ...
        "Rare",
        "Slash",
        os.path.join(base_directory, "assets/img/swords/holy_mantle.png"),
        os.path.join(base_directory, "assets/sound/swoosh.wav"),
        0.1,
        -15,
        15,
    ...
    "knockbackStick": Weapon(
        "Magic Stick",
        "Mythic",
        "Slash",
        os.path.join(base_directory, "assets/img/swords/knockback_stick.png"),
        os.path.join(base_directory, "assets/sound/swoosh.wav"),
        0.1,
        -15,
        15,
    ...
    "bladeOfTheTraveller": Weapon(
        "Blade of the Traveller",
        "Rare",
        "Slash",
        os.path.join(base_directory, "assets/img/swords/blade_of_the_traveller.png"),
        os.path.join(base_directory, "assets/sound/swoosh.wav"),
        0.1,
        -15,
        15,
